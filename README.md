...
|text (MS932) → Base64|Encode MS932 string using BASE64 encoder.|
...
|Base64 → text (MS932)|Decode BASE64 string and interpret as MS932 encoding.|
...
|postDataLimit|131072|The number of bytes that can be entered as the source text.|
